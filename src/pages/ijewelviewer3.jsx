...
const JewelViewer4 = () => {
    useEffect(() => {
        ...
        viewer
          ...
          .then(async(viewer) => {
            ...
            Promise.all([
              viewer.load("https://3dviewerdemo.s3.us-east-1.amazonaws.com/M2CW.glb"),
    ...
    return (
      <div id="ring-3d-output" className='active-viewer-check carreraycarrera' style={{ width: "100%", height: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
